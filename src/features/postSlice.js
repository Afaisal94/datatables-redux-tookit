...
export const fetchPostsByKeyword = createAsyncThunk("post/fetchPostsByKeyword", async ({currentPage, perPage, keyword}) => {
  const res = await axios.get(`https://jsonplaceholder.typicode.com/posts?title_like=${keyword}&_page=${currentPage}&_limit=${perPage}`);
